function result = run_coculture_adaptive_simulation_new(S0, R0, F0, u0, threshFrac)
    % Inputs:
    ...
    if ~exist('output_adaptive', 'dir')
        mkdir('output_adaptive');
    end

    csvname = sprintf('output_adaptive/adaptive_new_S0_%0.0f_R0_%0.0f_F0_%0.0f_u0_%0.2f_thresh_%0.2f.csv', ...
    ...
    png = sprintf('output_adaptive/adaptive_new_S0_%0.0f_R0_%0.0f_F0_%0.0f_u0_%0.2f_thresh_%0.2f.png', ...
        S0, R0, F0, u0, threshFrac);
    exportgraphics(fig, png, 'Resolution', 300);
end

%to run the function do this resul =
%run_coculture_adaptive_simulation_new(22500, 7500, 10000, 0.0, 0.5);
%new 1 max of 0.75
