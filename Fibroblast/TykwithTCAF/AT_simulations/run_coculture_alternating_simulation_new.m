function result = run_coculture_alternating_simulation_new(S0, R0, F0, u0)
    % Inputs:
    ...
    csvname = sprintf('output_alternating/alt_new_S0_%0.0f_R0_%0.0f_F0_%0.0f_u0_%0.1f.csv', S0, R0, F0, u0);
    ...
    title(sprintf('Alternating therapy: S0=%g, R0=%g, F0=%g', S0, R0, F0));
    grid on;
    ...
    pngname = sprintf('output_alternating/alt_new_S0_%0.0f_R0_%0.0f_F0_%0.0f_u0_%0.1f.png', S0, R0, F0, u0);
    exportgraphics(fig, pngname, 'Resolution', 300);
end

%run_coculture_alternating_simulation_new(22500, 7500, 10000, 0.0)