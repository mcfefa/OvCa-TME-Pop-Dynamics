function [res, BIC_conditions] = coculture_residuals_3pop_untreated_model2(p, K, alphaS, nS, IC50S, alphaR, nR, IC50R, t_data, S_raw_all, R_raw_all)
    ...
    for i = 1:3
        ...
        for j = 1:nReps
            ...
            [S_mod, R_mod] = simulate_coculture_3pop_untreated_model2( ...
                t_data, S0, R0, p, K, alphaS, nS, IC50S, alphaR, nR, IC50R);
